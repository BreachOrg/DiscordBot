    ...
    constructor(client) {
        ...
        client.on('interactionCreate', async (interaction) => {
            ...
            try {
                ...
                if (command.command?.default_member_permissions && interaction.memberPermissions && !interaction.memberPermissions.has(PermissionsBitField.resolve(command.command.default_member_permissions))) {
